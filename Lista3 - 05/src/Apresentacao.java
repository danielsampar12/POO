...
public class Apresentacao extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jButton3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Vereador v = camara.getMenorDesempenho();
				String str;
				if (v == null) {
		...
		jButton4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Vereador v = camara.getVereadorMaisProjAprovCamara();
				String str;
				if (v == null) {
					str = "Não há vereadores cadastrados";
				} else {
		...
		jButton5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					Partido p = camara.getNumeroPartido(Integer.parseInt(jTextField7.getText()));
					String str;
					if (p == null) {
						str = "Não há partido com este número";
					} else {
						str = "Partido " + p.getNome() + "\n\nTotal de projetos aprovados = " + p.getTotalProjAprov()
								+ "\nTotal de projetos apresentados = " + p.getTotalProjApresentados()
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
		String str;
		try {
			if (camara.getNumeroPartido(Integer.parseInt(jTextField1.getText())) == null) {
	...
	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
		Partido p = camara.getNumeroPartido(Integer.parseInt(jTextField4.getText()));
		if (p == null) {
			...
			try {
				...
				ver.setQtdProj(Integer.parseInt(jTextField5.getText()));
	...
	private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		int apres = camara.getTotalProjApresentados();
